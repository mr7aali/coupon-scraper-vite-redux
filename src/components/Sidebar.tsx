    ...
    <aside className="flex h-screen w-[280px] flex-col border-r border-[#F3F4F6] bg-white px-4 py-6">
      ...
      <div className="mt-auto border-t border-[#F3F4F6] pt-6">
        ...
        <div className="flex items-center gap-3 px-2 mb-6">
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            <span className="text-xs text-[#6B7280] truncate">
              {admin?.email || "admin@coupon.local"}
            </span>
          </div>
        </div>
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-[#E0F7FA] py-2.5 text-sm font-bold text-[#111827] transition-colors hover:bg-[#B2EBF2]"
        >
